#let random_numbers_uniformity_test = {
  [

    Una de las propiedades más importantes que debe cumplir un conjunto
    de números $r_i$ es la uniformidad. Para comprobar su acatamiento se
