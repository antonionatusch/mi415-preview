...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{MI415 - Modelación y Simulación}
\fancyhead[R]{Preguntas Introductorias Tema 1}
\fancyfoot[R]{\thepage}
\fancyfoot[L]{Antonio Natusch Zarco\\2022111958}
...
\begin{titlepage}
	\centering
	{\scshape\LARGE Universidad Privada de Santa Cruz de la Sierra \par}
	\vspace{1.5cm}
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=0.6\textwidth]{figures/upsa-logo.png}
		\end{center}
	\end{figure}

	\vspace{1.5cm}
	{\huge\bfseries Preguntas Introductorias Tema 1 \par}
	\vspace{1cm}
	{\Large\bfseries MI415 -- Modelación y Simulación\par}
	\vfill
	{\Large \textbf{Código de estudiante:} 2022111958\par}
	{\Large \textbf{Nombre:} Antonio Miguel Natusch Zarco\par}
	{\Large \textbf{Semestre:} Semestre 1/2026 \par}
	\vspace{1cm}
	\vfill
	\thispagestyle{empty}
\end{titlepage}
...
\addcontentsline{toc}{section}{Preguntas del PDF}
\begin{figure}[H]
	\centering
...
\begin{enumerate}
	\item \textbf{La simulación y por qué es una herramienta útil:} La simulación se refiere
	      a un gran conjunto de métodos y aplicaciones
	      ...
	      recrear situaciones o resultados tanto físicos como teóricos, teniendo su aplicación en sectores como ser la aeronáutica, procesos industriales, etc.
	      \citetitle[p.~2]{garcia2013simpromodel}

	\item \textbf{El propósito principal del modelaje en el contexto de la simulación:} Su propósito
	      es crear una representación simplificada y abstracta de un problema real.

	\item \textbf{Diferencia entre un modelo determinista y un modelo estocástico:} En un modelo
	      determinista, las relaciones entre los cambios de las variables del modelo son constantes.
	      En cambio, en un modelo estocástico, los cambios en las variables suelen
	      seguir algún modelo probabilístico donde el resultado
	      después de un evento no siempre es el mismo. \citetitle[p.~3]{garcia2013simpromodel}

	\item \textbf{Los tipos más comunes de simulación que existen, y las situaciones que se utilizan son:}
	      \begin{itemize}
		      ...
		      \item \small{\textbf{Simulación Basada en Agentes}: Modela sistemas donde múltiples entidades autónomas
			            (agentes) interactúan entre sí (ej. mercados económicos, comportamiento social).}
	      \end{itemize}\citetitle[p.~2]{machuca2025modysimtema1}
\end{enumerate}
\phantomsection
\newpage
\subsection*{Terminología Básica}
\addcontentsline{toc}{subsection}{Terminología Básica}
\begin{enumerate}
	\item \textbf{Qué es un modelo y cómo se diferencia de un sistema real:} Un modelo es una representación
	      o abstracción de una situación real, el cual puede ser de varios tipos.
	      Se diferencia de un sistema real en la medida que el objeto del modelo
	      es poder comprender, predecir y controlar el comportamiento de un sistema dado.

	\item \textbf{Definiciones de ``entidad'', ``atributo'', y ``evento'':}
	      \begin{itemize}
		      \item \textbf{Entidad:} Por lo general es \textit{la representación de los flujos de entrada
			            y salida en un sistema;} al entrar a un sistema una entidad es el elemento responsable
		            de que el estado del sistema cambie. \citetitle[p.~4]{garcia2013simpromodel}
		      ...
		      \item \textbf{Evento:} Es un \textit{cambio en el estado actual del sistema.}
		            ...
		            \begin{itemize}
			            ...
			            \item \textbf{Eventos futuros:} Cambios que
			                  se presentarán en el sistema después del tiempo de simulación, de acuerdo con una pro­
			                  gramación específica.
		            \end{itemize} \citetitle[p.~4]{garcia2013simpromodel}
	      \end{itemize}

	\item \textbf{Significados de Verificación y Validación de un modelo de simulación:}

	      \begin{itemize}
		      \item \textbf{Verificación:} Proceso en el cual, una vez identificadas
		            las distribuciones de probabilidad de las variables del modelo y se han
		            implantado los supuestos acordados, se comprueba la propiedad de la
		            programación del modelo, asegurándonos de que todos los parámetros en la
		            simulación funcionen correctamente. \citetitle[p.~13]{garcia2013simpromodel}

		      \item \textbf{Validación:} Proceso que consiste en pruebas simultáneas
		            con información de entrada real para observar su comportamiento y
		            analizar sus resultados. \citetitle[p.~14]{garcia2013simpromodel}
	      \end{itemize}

	\item \textbf{Definición del tiempo de simulación y cómo se utiliza:} \\Se define como
	      el \textit{periodo que se modela}, que puede ser diferente del tiempo real.
	      \citetitle[p.~4]{machuca2025modysimtema1}

	      Se utiliza durante la parametrización de la simulación, antes de ejecutar la corrida.
	      En el contexto del software \textbf{ProModel}, se introduce en el campo \textbf{``Run hours''}
	      dentro del comando \textbf{``Options''}, en el menú \textbf{``Simulation''}. \citetitle[p.~162]{garcia2013simpromodel}
\end{enumerate}
\phantomsection
\newpage
\subsection*{Conceptos Fundamentales de Simulación}
\addcontentsline{toc}{subsection}{Conceptos Fundamentales de Simulación}
\begin{enumerate}[label*=\arabic*.]
	\item \textbf{Los pasos principales en el proceso de desarrollo de un modelo de simulación son:}
	      \begin{enumerate}[label*=\arabic*.]
		      ...
		      \item \textbf{Generación del modelo de simulación base:} Una vez que se ha definido el
		            ...
		            estadística sobre el comportamiento de las variables de decisión del sistema.
		      ...
		      \item \textbf{Verificación del modelo:} Una vez que se han identificado las distribuciones de
		            ...
		            comparación con la realidad del problema que se está modelando. A esta etapa
		      ...
		      \item \textbf{Validación del modelo:} El proceso de validación del modelo consiste en realizar
		            ...
		            realmente en nuestro proceso. \\Por otro lado, si se está diseñando un nuevo proceso
		            la validación resulta más complicada. Una manera de validar el modelo en
		      ...
		      \item \textbf{Generación del modelo final:} Una vez que el modelo se ha validado, el analista
		            ...
		            este será el modelo \textit{raíz}; en tal situación, el siguiente paso es la \textit{\textbf{definición de los escenarios a analizar.}}
		      ...
		      \item \textbf{Determinación de los escenarios para el análisis:} Tras validar el modelo es
		            ...
		            uno optimista y uno intermedio para la variable de respuesta más importante.
		      ...
		      \item \textbf{Documentación del modelo, sugerencias y conclusiones:} Una vez realizado el
		            ...
		            alcances y limitaciones y, en general, la totalidad de las consideraciones de .
	...
	\item \textbf{Definición de estado:} Condición que guarda el sistema bajo estudio en un
	      ...
	      sistema en cierto instante. El estado del sistema se compone de variables o características
	      de operación puntuales (digamos el número de piezas que hay en el sistema en ese
...
\addcontentsline{toc}{subsection}{Ventajas y Desventajas del Uso de la Simulación}
\begin{enumerate}
	      ...
	      \begin{enumerate}
		      \item \underline{\textbf{Optimización y costos:}} Aunque muchos paquetes
		            ...
		            partir de una combinación de variaciones posibles, la simulación \textbf{no
			            es una herramienta de optimización;} además, \textbf{puede ser costosa cuando
		      ...
		      \item \underline{\textbf{Conocimientos previos:}} Es preciso que el analista
		            ...
		            parametrización.
	      \end{enumerate} \citetitle[p.~10]{garcia2013simpromodel}
	      \newpage
	\item \textbf{Situaciones donde es más beneficioso un modelo de simulación sobre un modelo analítico:}
	      ...
	      \end{enumerate} \citetitle[p.~7]{machuca2025modysimtema1}
